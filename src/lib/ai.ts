  ...
  if (selectedProvider === "gemini") {
    ...
    try {
      const response = await client.models.generateContent({
        ...
        config: {
          systemInstruction:
            "You are Content Forge, a content transformation strategist. Create platform-aware, human-led plans. Never recommend spam, fake engagement, mass messaging, or automated social abuse. Return JSON only.",
